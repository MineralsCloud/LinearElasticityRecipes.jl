...
[discuss with us](https://github.com/MineralsCloud/LinearElasticityRecipes.jl/discussions).

If you have additional tips, please either
[report an issue](https://github.com/MineralsCloud/LinearElasticityRecipes.jl/issues/new) or
[submit a PR](https://github.com/MineralsCloud/LinearElasticityRecipes.jl/compare) with suggestions.
...
## Loading LinearElasticityRecipes
